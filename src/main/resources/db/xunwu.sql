...
CREATE TABLE `house_picture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='房屋图片信息';

-- ----------------------------
--  Records of `house_picture`
-- ----------------------------
BEGIN;
INSERT INTO `house_picture` VALUES ('68', '19', 'http://pxjlwhmqx.bkt.clouddn.com/', '911', '683', null, 'Fp1xPKVYtPsCeVHVQVW0Hif2FXk7'), ('69', '19', 'http://pxjlwhmqx.bkt.clouddn.com/', '1012', '683', null, 'Fn371N5gLsJvjuIRC4IHjPtMy61h'), ('70', '24', 'http://pxjlwhmqx.bkt.clouddn.com/', '1280', '960', null, 'Fn1AGNmZfadCIVTJA33gByg6a33B'), ('71', '24', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FlgoAylUv1ilx1SAtxSyBCJF3bwb'), ('72', '21', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FnuOFbFtDYTbpPdFoZthR-R0tszC'), ('73', '21', 'http://pxjlwhmqx.bkt.clouddn.com/', '455', '683', null, 'FhCiRnyCDQ-O6pXusu5ftmZkIh0-'), ('74', '20', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FvVqU8LneZZ5xaLBAOM1KXR2Pz1X'), ('75', '20', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FtNl9uPM6p5PjEs8z2FnOuViNtOM'), ('76', '18', 'http://pxjlwhmqx.bkt.clouddn.com/', '1440', '960', null, 'FgcD3BufAprERe5y3Gd-Mezu5VAy'), ('77', '18', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'Fl1lNikhmMIecbTn-JTsurxugtFU'), ('78', '17', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FvVHtS1qAApFFh6k5LMDm5tliufK'), ('79', '17', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FpVYJRsLykrBRyUSCEOeqsqWU-bt'), ('80', '16', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'Fhysh6EcQ_ZTl-jdGe2zaCFi5Uvm'), ('81', '16', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'Fvb9TDMRtl1haBj9gK9C0k43X0u0'), ('82', '16', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FvkO1FFyGbrxCP_1O9tA94u2qvbP'), ('83', '15', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FsxiS6rOTpSg5pK7tv41e8Zpnn_c'), ('84', '15', 'http://pxjlwhmqx.bkt.clouddn.com/', '1024', '683', null, 'FpOKJ2IEmbA1y1RbIqgZfqFKkJyS'), ('85', '15', 'http://pxjlwhmqx.bkt.clouddn.com/', '1440', '960', null, 'Fhxz_c16YmEmIz5UVxrp6ihwbvCk');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='预约看房信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='房屋标签映射关系表';
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'waliwali', 'wali@wali.com', '15111111111', '6fd1aad88b038aeecd9adeccc92b0bd1', '1', '2017-08-25 15:18:20', '2017-08-25 12:00:00', '2017-11-26 10:29:02', 'http://pxjlwhmqx.bkt.clouddn.com/99ff568bd61c744bf31185aeddf13580.png'), ('2', 'admin', 'admin@imooc.com', '1388888888', '55b3d0936a3fb63168d57a6bda0ddbbf', '1', '2017-08-27 09:07:05', '2017-08-27 09:07:07', '2017-10-21 15:03:57', 'http://pxjlwhmqx.bkt.clouddn.com/99ff568bd61c744bf31185aeddf13580.png'), ('5', '138****8888', null, '13888888888', null, '0', '2017-11-25 17:56:45', '2017-11-25 17:56:45', '2017-11-25 17:56:45', null), ('8', '151****9677', null, '15110059677', null, '0', '2017-11-25 18:58:18', '2017-11-25 18:58:18', '2017-11-25 18:58:18', null);
COMMIT;
